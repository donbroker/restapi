...
function geodir_custom_post_type_uninstall(){
	if ( ! isset($_REQUEST['verify-delete-adon']) ) 
	{
		$plugins = isset( $_REQUEST['checked'] ) ? (array) $_REQUEST['checked'] : array();
			...
			wp_enqueue_script('jquery');
					...
					printf( '<h2>%s</h2>' ,__( 'Warning!!' , 'geodir_custom_posts') );
					printf( '%s<br/><strong>%s</strong><br /><br />%s <a href="http://wpgeodirectory.com">%s</a>.' , __('You are about to delete a Geodirectory Add-on which has important option and custom data associated to it.' ,'geodir_custom_posts') ,__('Deleting this and activating another version, will be treated as a new installation of plugin, so all the data will be lost.', 'geodir_custom_posts'), __('If you have any problem in upgrading the plugin please contact Geodirectory', 'geodir_custom_posts') , __('support' ,'geodir_custom_posts') ) ;
	...
	?><br /><br />
		<form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" style="display:inline;">
						...
						<?php submit_button(  __( 'Delete plugin files only' , 'geodir_custom_posts' ), 'button', 'submit', false ); ?>
					</form>
					<form method="post" action="<?php echo esc_url($_SERVER['REQUEST_URI']); ?>" style="display:inline;">
						<input type="hidden" name="verify-delete" value="1" />
						<input type="hidden" name="action" value="delete-selected" />
						...
						?>
						<?php wp_nonce_field('bulk-plugins') ?>
						<?php submit_button(  __( 'Delete both plugin files and data' , 'geodir_custom_posts') , 'button', 'submit', false ); ?>
					</form>
		...
		if(!empty($geodir_custom_post_types))
		{
			foreach($geodir_custom_post_types as $key)
			{
				...
				if (array_key_exists($key, $geodir_post_types))
				{
					...
					geodir_custom_post_type_ajax($key); /* delete all related data */
				}
...
function geodir_cp_create_default_fields($custom_post_type, $package_id='')
{
	...
	$fields[]	= array(	'listing_type' 	=> $custom_post_type, 
						'data_type' 	=> 'VARCHAR', 
						'field_type' 	=> 'taxonomy', 
						'admin_title' 	=> __( 'Category', 'geodir_custom_posts' ),
						'admin_desc' 	=> __( 'Select listing category from here. Select at least one category', 'geodir_custom_posts' ),
						'site_title' 	=> __('Category', 'geodir_custom_posts' ),
						...
						'clabels'		=> __('Category', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'address', 
							'admin_title' 	=> __('Address', 'geodir_custom_posts' ),
							'admin_desc' 	=> ADDRESS_MSG, 
							'site_title' 	=> __('Address', 'geodir_custom_posts' ),
							'htmlvar_name' 	=> 'post', 
							'default_value'	=> '', 
							'option_values' => '', 
							'is_default'  	=> '1',
							...
							'show_on_pkg' => array($package_id),
							'is_required'	=> '1',
							'required_msg'	=> __('Address fields are required', 'geodir_custom_posts' ),
							'clabels'		=> 'Address',
							'extra'	=> array(	'show_city'=> 1 , 'city_lable' => __('City', 'geodir_custom_posts' ),
												'show_region' => 1, 'region_lable' => __('Region', 'geodir_custom_posts' ),
												'show_country' => 1, 'country_lable' => __('Country', 'geodir_custom_posts' ),
												'show_zip' => 1, 'zip_lable' => __('Zip/Post Code', 'geodir_custom_posts' ),
												'show_map' => 1, 'map_lable' => __('Set Address On Map', 'geodir_custom_posts' ),
												'show_mapview' => 1, 'mapview_lable' => __('Select Map View', 'geodir_custom_posts' ),
	...
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'text', 
							'admin_title' 	=> __( 'Time', 'geodir_custom_posts' ),
							'admin_desc' 	=> __('Enter Business or Listing Timing Information.<br/>eg. : 10.00 am to 6 pm every day', 'geodir_custom_posts' ),
							'site_title' 	=> __( 'Time', 'geodir_custom_posts' ),
							'htmlvar_name' 	=> 'timing', 
							'default_value'	=> '', 
							'option_values' => '',
							'is_default'  	=> '1',
							'is_admin'			=> '1', 
							'show_on_pkg' => array($package_id),
							'clabels'		=> __( 'Time', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'phone', 
							'admin_title' 	=> __( 'Phone', 'geodir_custom_posts' ),
							'admin_desc' 	=> __( 'You can enter phone number,cell phone number etc.', 'geodir_custom_posts' ),
							'site_title' 	=> __( 'Phone', 'geodir_custom_posts' ),
							...
							'is_admin'			=> '1', 
							'show_on_pkg' => array($package_id),
							'clabels'		=> __( 'Phone', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'email', 
							'admin_title' 	=> __( 'Email', 'geodir_custom_posts' ),
							'admin_desc' 	=> __( 'You can enter your business or listing email.', 'geodir_custom_posts' ),
							'site_title' 	=> __( 'Email', 'geodir_custom_posts' ),
							'htmlvar_name' 	=> 'email', 
							'default_value'	=> '', 
							'option_values' => '',
							'is_default'  	=> '1',
							'is_admin'			=> '1',
							'show_on_pkg' => array($package_id), 
							'clabels'		=> __( 'Email', 'geodir_custom_posts' ));
							
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'url', 
							'admin_title' 	=> __( 'Website', 'geodir_custom_posts' ),
							'admin_desc' 	=> __( 'You can enter your business or listing website.', 'geodir_custom_posts' ),
							'site_title' 	=> __('Website', 'geodir_custom_posts' ),
							'htmlvar_name' 	=> 'website', 
							'default_value'	=> '', 
							'is_default'  	=> '1',
							'is_admin'			=> '1',
							'show_on_pkg' => array($package_id),
							'clabels'		=> __('Website', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'url', 
							'admin_title' 	=> __('Twitter', 'geodir_custom_posts' ),
							'admin_desc' 	=> __('You can enter your business or listing twitter url.', 'geodir_custom_posts' ),
							'site_title' 	=> __('Twitter', 'geodir_custom_posts' ),
							...
							'is_admin'			=> '1',
							'show_on_pkg' => array($package_id),
							'clabels'		=> __('Twitter', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'VARCHAR', 
							'field_type' 	=> 'url', 
							'admin_title' 	=> __('Facebook', 'geodir_custom_posts' ),
							'admin_desc' 	=> __('You can enter your business or listing facebook url.', 'geodir_custom_posts' ),
							'site_title' 	=> __('Facebook', 'geodir_custom_posts' ),
							...
							'is_admin'			=> '1', 
							'show_on_pkg' => array($package_id),
							'clabels'		=> __('Facebook', 'geodir_custom_posts' ));
							
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'TEXT', 
							'field_type' 	=> 'textarea', 
							'admin_title' 	=> __('Video', 'geodir_custom_posts' ),
							'admin_desc' 	=> __('Add video code here, YouTube etc.', 'geodir_custom_posts' ),
							'site_title' 	=> __('Video', 'geodir_custom_posts' ),
							'htmlvar_name' 	=> 'video', 
							'default_value'	=> '', 
							'option_values' => '',
							'is_default'  	=> '0',
							'is_admin'			=> '1',
							'show_on_pkg' => array($package_id),
							'clabels'		=> __('Video', 'geodir_custom_posts' ));
	
	$fields[]	= array(	'listing_type'	=> $custom_post_type, 
							'data_type' 	=> 'TEXT', 
							'field_type' 	=> 'textarea', 
							'admin_title' 	=> __('Special Offers', 'geodir_custom_posts' ),
							'admin_desc' 	=> __('Note: List out any special offers (optional)', 'geodir_custom_posts' ),
							'site_title' 	=> __('Special Offers', 'geodir_custom_posts' ),
							...
							'is_admin'			=> '1',
							'show_on_pkg' => array($package_id),
							'clabels'		=> __('Special Offers', 'geodir_custom_posts' ));
		...
		foreach ( $general_settings as $setting ) {
			if ( isset( $setting['id'] ) && $setting['id']=='general_options' && isset( $setting['type'] ) && $setting['type']=='sectionend' ) {
				$extra_setting = array(
									...
									'desc' => __( 'Select the post types that does not require geographic position/physical location. All fields will be disabled that related to geographic position/physical location.', 'geodir_custom_posts' ),
									'tip' => '',
