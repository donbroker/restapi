	...
	*/
	public function frontendScripts()
	{
		...
		wp_enqueue_script(
			...
			$this->plugin_dir . '/assets/js/src/simple-favorites.js', 
			array('jquery'), 
			$this->plugin_version
		);
		wp_localize_script(
			...
			array(
				...
				'like'                   => $this->settings_repo->likeButtonText(),
				'liked'                  => $this->settings_repo->buttonTextLiked(),
				'dislike'                => $this->settings_repo->dislikeButtonText(),
				'disliked'               => $this->settings_repo->buttonTextDisliked(),
				'includecount'           => $this->settings_repo->includeCountInButton(),
				'includelikecount'       => $this->settings_repo->includeCountInLikeButton(),
				'includedislikecount'    => $this->settings_repo->includeCountInDislikeButton(),
