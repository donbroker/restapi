...
class Helpers 
{
	...
	* @return array
	*/
	public static function pluckSiteLikes($site_id, $all_likes)
	{
		foreach($all_likes as $site_likes){
			if ( $site_likes['site_id'] == $site_id && isset($site_likes['posts']) ) return $site_likes['posts'];
		}
		return array();
	}
	...
	* @return array
	*/
	public static function pluckSiteDislikes($site_id, $all_dislikes)
	{
		foreach($all_dislikes as $site_dislikes){
			if ( $site_dislikes['site_id'] == $site_id && isset($site_dislikes['posts']) ) return $site_dislikes['posts'];
		}
		return array();
	}
