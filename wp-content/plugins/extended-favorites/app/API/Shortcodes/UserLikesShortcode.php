...
class UserLikesShortcode 
{
	...
	*/
	...
	{
		add_shortcode('user_likes', array($this, 'renderView'));
	}
	...
	*/
	public function renderView($options)
	{
		...
		$likes = new UserLikes($this->options['user_id'], $this->options['site_id'], $this->options['include_links'], $this->filters);
		return $likes->getLikesList($this->options['include_buttons']);
	}
