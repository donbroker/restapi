...
class UserDislikeCount 
{
	...
	*/
	...
	{
		add_shortcode('user_dislike_count', array($this, 'renderView'));
	}
	...
	*/
	public function renderView($options)
	{
		...
		return get_user_dislikes_count($this->options['user_id'], $this->options['site_id'], $this->filters, true);
	}
