...
class UserDislikesShortcode 
{
	...
	*/
	...
	{
		add_shortcode('user_dislikes', array($this, 'renderView'));
	}
	...
	*/
	public function renderView($options)
	{
		...
		$dislikes = new UserDislikes($this->options['user_id'], $this->options['site_id'], $this->options['include_links'], $this->filters);
		return $dislikes->getDislikesList($this->options['include_buttons']);
	}
